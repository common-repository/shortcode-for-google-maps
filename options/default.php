...
<p><code>[sc-gmaps address=&quot;123 Main Street, Sydney 12345, Australia&quot;]</code> (Basic Mode)</p>
<p><code>[sc-gmaps map=&quot;99&quot;]</code> (Advanced Mode)</p>
<p>There are more attributes available, which you can use to configure the map results.</p>
<h2>Short Code Attributes</h2>
<table width="100%" border="0" cellpadding="10" class="scgm-table">
	<tr>
	...
	<tr>
		<td><code>map</code></td>
		<td>ID of a saved map.<br />
			If used, all other attributes are ignored and values are taken from saved map and locations.</td>
		<td>-</td>
		<td>-</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>URL of the map marker icon.<br />
			...
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/blue.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/green.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/litegreen.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/orange.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/pink.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/red.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/skyblue.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/teal.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/teapink.png" />
			<img src="<?php echo sc_GMAPS_IMGURL; ?>/markers/yellow.png" />
		</td>
		<td>Optional</td>
